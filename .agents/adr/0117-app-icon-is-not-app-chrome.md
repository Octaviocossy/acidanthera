...
for no brand mark at all — ADR 0109 decision 16 had already refused the ember to the mark on the
sidebar rail. Rather than amend ADR 0105, we draw the boundary at the window's edge: an icon
...
Amending ADR 0105 to sanction the brand mark as a second ember surface in chrome was the
