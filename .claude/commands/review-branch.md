...
allowed-tools: Bash(git:*), Bash(mkdir:*), Bash(gh issue view:*), Bash(sh .agents/scripts/build-corpus-pack.sh:*), Bash(sh .agents/scripts/run-review-agent.sh:*), mcp__github__issue_read, mcp__github__list_issues, mcp__github__list_pull_requests
---
