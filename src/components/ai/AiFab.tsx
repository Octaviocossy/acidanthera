...
/**
 * The floating AI button — bottom-right, the *only* place the reserved lime accent
...
export function AiFab() {
  ...
  return (
    <button
      ...
      className={cn(
        'absolute right-4 bottom-4 flex h-[var(--rail-fab)] w-[var(--rail-fab)] items-center justify-center rounded-full border bg-surface-2 transition-colors duration-[var(--dur)] ease-orbit hover:bg-border-active',
