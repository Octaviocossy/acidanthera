...
export function ChatInput({ disabled = false, onSubmit }: ChatInputProps) {
  ...
  return (
    <div className="border-t border-border-hairline p-3">
      <div className="flex items-center gap-2 rounded-sm border border-border-hairline bg-surface px-3 py-2 transition-colors duration-[var(--dur)] ease-orbit focus-within:border-text">
