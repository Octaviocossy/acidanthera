...
const BASE_SETTINGS: Settings = { model: 'sonnet-5', editorFont: 'JetBrains Mono', theme: 'dark', vaultPath: '/vault', dailyNoteFolder: 'daily' };
...
describe('applyReloadedSettings', () => {
  ...
  it('keeps the last-good settings on a syntax error, updating only diagnostics', () => {
    ...
    const reloaded: SettingsReadResult = {
      settings: { model: 'gpt-5.4-mini', editorFont: 'JetBrains Mono', theme: 'dark', vaultPath: '/vault', dailyNoteFolder: 'daily' },
